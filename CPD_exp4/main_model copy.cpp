...
const double ydim = 1600*pow(10,-6); //y length of simulation in microns
const double zdim = 160*pow(10,-6); //z length of simulation in microns
    ...
    for(int t =0;t<int(tStop/dt);t++){
        ...
        if (t == int(CPD_time/dt) ){
            if (CPD_flag==1){
                ...
                for(int i = 0; i <cell_num; i++){
                    if( (cells[i][1]>ydim/2-450*pow(10,-6)) &&(cells[i][1]<ydim/2+450*pow(10,-6))  &&(cells[i][2] <30*pow(10,-6)) ){
