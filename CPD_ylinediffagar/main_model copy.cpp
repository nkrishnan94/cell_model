...
int main(){
    ...
    long double y_space =  (double(ydim))/double(ycells);
        ...
        for(int y =0; y<ycells;y++){
            for(int x =0; x<xcells;x++){
                if(cell_count<cell_num){
                    ...
                    cells[cell_count][1] = double(R*1.1+y*y_space);
                    cells[cell_count][2]= double(.9*a*R+z*z_space);
